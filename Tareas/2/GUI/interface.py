...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.Pestana_principal.setGeometry(QtCore.QRect(10, 10, 761, 811))
        ...
        self.boton_inicio_2 = QtWidgets.QPushButton(self.tab)
        self.boton_inicio_2.setGeometry(QtCore.QRect(350, -50, 93, 28))
        self.boton_inicio_2.setObjectName("boton_inicio_2")
        self.selec_esp = QtWidgets.QComboBox(self.tab)
        self.selec_esp.setGeometry(QtCore.QRect(300, 50, 181, 31))
        ...
        self.boton_configuracion_3.setGeometry(QtCore.QRect(490, 50, 121, 31))
...
"color: rgb(255, 255, 255);")
        ...
        self.boton_configuracion.setGeometry(QtCore.QRect(270, 440, 191, 28))
...
"color: rgb(255, 255, 255);")
        ...
        self.label_1.setGeometry(QtCore.QRect(140, 60, 161, 21))
...
"")
        ...
        self.text_disc_time = QtWidgets.QLineEdit(self.tab)
...
"color: rgb(255, 255, 255);")
        ...
        self.box_modo_op = QtWidgets.QComboBox(self.tab)
        self.box_modo_op.setGeometry(QtCore.QRect(100, 550, 181, 31))
        self.box_modo_op.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.box_modo_op.setObjectName("box_modo_op")
        self.box_modo_op.addItem("")
        self.box_modo_op.addItem("")
        self.box_modo_op.addItem("")
        self.box_modo_op.addItem("")
        self.box_modo_op.addItem("")
        ...
        self.label_29.setGeometry(QtCore.QRect(140, 520, 101, 21))
...
"color: rgb(255, 255, 255);")
        ...
        self.box_id_protocol = QtWidgets.QComboBox(self.tab)
        self.box_id_protocol.setGeometry(QtCore.QRect(400, 550, 181, 31))
        self.box_id_protocol.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.box_id_protocol.setObjectName("box_id_protocol")
        self.box_id_protocol.addItem("")
        self.box_id_protocol.addItem("")
        self.box_id_protocol.addItem("")
        self.box_id_protocol.addItem("")
        self.box_id_protocol.addItem("")
        self.label_30 = QtWidgets.QLabel(self.tab)
        self.label_30.setGeometry(QtCore.QRect(450, 520, 101, 21))
        self.label_30.setStyleSheet("color: rgb(0, 0, 0);\n"
"\n"
"")
        self.label_30.setObjectName("label_30")
        self.box_acc_sampling = QtWidgets.QComboBox(self.tab)
        self.box_acc_sampling.setGeometry(QtCore.QRect(240, 180, 111, 31))
        self.box_acc_sampling.setObjectName("box_acc_sampling")
        self.box_acc_sampling.addItem("")
        self.box_acc_sampling.addItem("")
        self.box_acc_sampling.addItem("")
        self.box_acc_sampling.addItem("")
        self.box_acc_sensibility = QtWidgets.QComboBox(self.tab)
        self.box_acc_sensibility.setGeometry(QtCore.QRect(240, 230, 111, 31))
        self.box_acc_sensibility.setObjectName("box_acc_sensibility")
        self.box_acc_sensibility.addItem("")
        self.box_acc_sensibility.addItem("")
        self.box_acc_sensibility.addItem("")
        self.box_acc_sensibility.addItem("")
        self.box_acc_sensibility.addItem("")
        self.box_acc_sensibility.setItemText(4, "")
        self.box_gyro_sensibility = QtWidgets.QComboBox(self.tab)
        self.box_gyro_sensibility.setGeometry(QtCore.QRect(240, 280, 111, 31))
        self.box_gyro_sensibility.setObjectName("box_gyro_sensibility")
        self.box_gyro_sensibility.addItem("")
        self.box_gyro_sensibility.addItem("")
        self.box_gyro_sensibility.addItem("")
        self.box_bme_sampling = QtWidgets.QComboBox(self.tab)
        self.box_bme_sampling.setGeometry(QtCore.QRect(240, 330, 111, 31))
        self.box_bme_sampling.setObjectName("box_bme_sampling")
        self.box_bme_sampling.addItem("")
        self.box_bme_sampling.addItem("")
        self.box_bme_sampling.addItem("")
        self.box_bme_sampling.addItem("")
        self.boton_configuracion_2 = QtWidgets.QPushButton(self.tab)
        self.boton_configuracion_2.setGeometry(QtCore.QRect(270, 480, 191, 28))
        self.boton_configuracion_2.setStyleSheet("background-color: rgb(5, 5, 203);\n"
"color: rgb(255, 255, 255);")
        self.boton_configuracion_2.setObjectName("boton_configuracion_2")
...
"")
        ...
        self.selec_plot1.setGeometry(QtCore.QRect(370, 20, 171, 31))
        ...
        self.selec_plot2.setGeometry(QtCore.QRect(370, 200, 171, 31))
        ...
        self.selec_plot3.setGeometry(QtCore.QRect(370, 370, 171, 31))
...
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.boton_configuracion.setText(_translate("Dialog", "Guardar configuracion en la DB"))
        ...
        self.box_modo_op.setItemText(0, _translate("Dialog", "Configuración por Bluetooth "))
        self.box_modo_op.setItemText(1, _translate("Dialog", "Configuración vía TCP en BD "))
        self.box_modo_op.setItemText(2, _translate("Dialog", "Conexión TCP continua"))
        self.box_modo_op.setItemText(3, _translate("Dialog", "Conexión TCP discontinua"))
        self.box_modo_op.setItemText(4, _translate("Dialog", "Conexión UDP"))
        self.box_modo_op.setItemText(5, _translate("Dialog", "BLE continua "))
        self.box_modo_op.setItemText(6, _translate("Dialog", "BLE discontinua"))
        self.label_29.setText(_translate("Dialog", "Modo de operacion"))
        self.boton_detener.setText(_translate("Dialog", "Detener monitoreo"))
        self.box_id_protocol.setItemText(0, _translate("Dialog", "1"))
        self.box_id_protocol.setItemText(1, _translate("Dialog", "2"))
        self.box_id_protocol.setItemText(2, _translate("Dialog", "3"))
        self.box_id_protocol.setItemText(3, _translate("Dialog", "4"))
        self.box_id_protocol.setItemText(4, _translate("Dialog", "5"))
        self.label_30.setText(_translate("Dialog", "Id protocols"))
        self.box_acc_sampling.setItemText(0, _translate("Dialog", "10"))
        self.box_acc_sampling.setItemText(1, _translate("Dialog", "100"))
        self.box_acc_sampling.setItemText(2, _translate("Dialog", "400"))
        self.box_acc_sampling.setItemText(3, _translate("Dialog", "1000"))
        self.box_acc_sensibility.setItemText(0, _translate("Dialog", "2"))
        self.box_acc_sensibility.setItemText(1, _translate("Dialog", "4"))
        self.box_acc_sensibility.setItemText(2, _translate("Dialog", "8"))
        self.box_acc_sensibility.setItemText(3, _translate("Dialog", "16"))
        self.box_gyro_sensibility.setItemText(0, _translate("Dialog", "200"))
        self.box_gyro_sensibility.setItemText(1, _translate("Dialog", "250"))
        self.box_gyro_sensibility.setItemText(2, _translate("Dialog", "500"))
        self.box_bme_sampling.setItemText(0, _translate("Dialog", "1"))
        self.box_bme_sampling.setItemText(1, _translate("Dialog", "2"))
        self.box_bme_sampling.setItemText(2, _translate("Dialog", "3"))
        self.box_bme_sampling.setItemText(3, _translate("Dialog", "4"))
        self.boton_configuracion_2.setText(_translate("Dialog", "Mandar configuracion a ESP"))
        ...
        self.boton_detener_graficar.setText(_translate("Dialog", "Graficar"))

...
class Ui_Dialog(object):
    ...
    def print_text_edits_values(self):
        # Obtener los valores de los widgets QTextEdit
        acc_sampling_value = self.text_acc_sampling.toPlainText()
        acc_sensibility_value = self.text_acc_sensibity.toPlainText()
        gyro_sensibility_value = self.text_gyro_sensibility.toPlainText()
        # Imprimir estos valores
        print("Acc Sampling:", acc_sampling_value)
        print("Acc Sensibility:", acc_sensibility_value)
        print("Gyro Sensibility:", gyro_sensibility_value)
...
"color: rgb(255, 255, 255);")
        ...
        self.boton_configuracion.clicked.connect(self.print_text_edits_values)
        ...
        self.label_1.setGeometry(QtCore.QRect(140, 60, 141, 21))
